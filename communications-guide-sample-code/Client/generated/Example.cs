...
namespace Example
{
    ...
    public sealed class ConverterPrxHelper : Ice.ObjectPrxHelperBase, ConverterPrx
    {
        ...
        {
            return this.toUpper(s, null, false);
        }

        public string toUpper(string s, _System.Collections.Generic.Dictionary<string, string> context__)
        {
            return this.toUpper(s, context__, true);
        }

        private string toUpper(string s, _System.Collections.Generic.Dictionary<string, string> context__, bool explicitCtx__)
        {
            checkTwowayOnly__(__toUpper_name);
            return end_toUpper(begin_toUpper(s, context__, explicitCtx__, true, null, null));
        }
        ...
        {
            return begin_toUpper(s, null, false, false, null, null);
        }
        ...
        {
            return begin_toUpper(s, ctx__, true, false, null, null);
        }

        public Ice.AsyncResult begin_toUpper(string s, Ice.AsyncCallback cb__, object cookie__)
        {
            return begin_toUpper(s, null, false, false, cb__, cookie__);
        }
        ...
        {
            return begin_toUpper(s, ctx__, true, false, cb__, cookie__);
        }
        ...
        {
            IceInternal.OutgoingAsync outAsync__ = IceInternal.OutgoingAsync.check(r__, this, __toUpper_name);
            try
            {
                if(!outAsync__.wait())
                {
        ...
        private Ice.AsyncResult<Example.Callback_Converter_toUpper> begin_toUpper(string s, _System.Collections.Generic.Dictionary<string, string> ctx__, bool explicitContext__, bool synchronous__, Ice.AsyncCallback cb__, object cookie__)
        {
            checkAsyncTwowayOnly__(__toUpper_name);
            IceInternal.TwowayOutgoingAsync<Example.Callback_Converter_toUpper> result__ =  getTwowayOutgoingAsync<Example.Callback_Converter_toUpper>(__toUpper_name, toUpper_completed__, cookie__);
            if(cb__ != null)
            {
            ...
            try
            {
                result__.prepare(__toUpper_name, Ice.OperationMode.Normal, ctx__, explicitContext__, synchronous__);
